    ...
    <div class="container">
        ...
        <div class="row">
            @foreach ($images as $ph)
                <div class="col-md-4 mb-4"> http://127.0.0.1:8887/storage/app/
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">{{ $ph->nom }}</h5>
                            <img src="{{ asset('http://127.0.0.1:8887/storage/app//storage/images/' . $ph->nom) }}" class="card-img-top img-thumbnail" alt="{{ $ph->nom }}">
