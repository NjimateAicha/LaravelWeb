        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <br>
                    <button class="btn custom-btn" onclick="generateMatrix('matrix1')">Générer des valeurs aléatoires</button>
                    <textarea class="form-control mt-3" id="matrix1" readonly></textarea>
                    <button class="btn custom-btn mt-3" onclick="calculateSum('matrix1')">Calculer la somme</button>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <br>
                    <button class="btn custom-btn" onclick="generateMatrix('matrix2')">Générer des valeurs aléatoires</button>
    
                    <textarea class="form-control mt-3" id="matrix2" readonly></textarea>
                    <button class="btn custom-btn mt-3" onclick="calculateProduct('matrix2')">Calculer le produit</button>
                    <div class="result mt-3">
