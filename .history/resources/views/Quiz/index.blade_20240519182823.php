...
<style>
    ...
    thead th {
        color: #7777af; /* Couleur du texte */
        background-color: #eee; /* Couleur de fond */
        border-color: #7777af; /* Couleur de la bordure */
    }
</style>
    ...
    <div class="row">
        <div class="col-md-6 mb-4"> <!-- Ajout de la classe mb-4 pour un espacement en bas -->
            <div class="input-container" id="quiz1Container">
                ...
                <a href="{{ route('quiz.javascript') }}" class="btn custom-btn ">Commencer le quiz JavaScript</a>
            </div>
        </div>
        <div class="col-md-6 mb-4"> <!-- Ajout de la classe mb-4 pour un espacement en bas -->
            <div class="input-container" id="quiz2Container">
                ...
                <a href="{{ route('quiz.php') }}" class="btn custom-btn ">Commencer le quiz PHP</a>
            </div>
        </div>
    </div>
</div>
