            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="note1" name="note1" value="{{ $etudiant->note1 }}" required>
                    </div>
                    <div class="form-group">
                        <label for="note2">Module 2 :</label>
                        <input type="number" class="form-control" id="note2" name="note2" value="{{ $etudiant->note2 }}" required>
                    </div>
                </div>
            </div>
        </div>
