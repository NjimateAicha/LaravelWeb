...
<head>
    ...
    <title>{{ config('app.name', 'Lafraouzi') }}</title>
                ...
                <div class="row justify-content-between">
                    <div class="col-md-6">
                        <div class="text-gray-600">
                            <p>Contactez Moi :</p>
                            <p class="d-inline">Téléphone : <span style="color: blue;">(+212) 6 16 40 85 59</span></p>
                            <br>
                            <p class="d-inline">Email : <span style="color: blue;">Lafraouzimouhssine@gmail.com</span>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6">
