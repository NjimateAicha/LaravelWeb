    ...
    public function store(Request $request)
{
    ...
    $request->file('image_file')->storeAs('public/images/', $name);
...
class ImageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('image.create')->with('success', 'Image enregistrée avec succès.');
    }

    public function destroy(Image $image)
    {
        $imagePath = public_path('images/' . $image->nom);
